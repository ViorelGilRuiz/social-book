...
import com.Viorel.Book_Network.book.BookRepository;
...
public class FeedbackService {
    ...
    private final FeedbackRepostory feedbackRepostory;
    ...
    public Integer save(FeedbackRequest request, Authentication connectedUser) {
        ...
        return feedbackRepostory.save(feedback).getId();
    }
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(Integer bookId, int page, int size, Authentication connectedUser) {
        ...
        User user = ((User) connectedUser.getPrincipal());
        Page<Feedback> feedbacks = feedbackRepostory.findAllByBookId(bookId, pageable);
